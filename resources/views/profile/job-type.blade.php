                ...
                <div class="modal fade" id="add_assets">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('job-type.store') }}" method="POST" role="form">
                                @csrf
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @foreach ($types as $list)
                                <tr>
                                    <td>
                                        <h6 class="fs-14 fw-medium">{{ $list->libelle_type }}</h6>
                                    </td>
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="#" class="me-2" data-bs-toggle="modal"
                                                data-bs-target="#edit_category{{ $list->idjob_type }}"><i
                                                    class="ti ti-edit"></i></a>
                                            <div class="modal fade" id="edit_category{{ $list->idjob_type }}">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <form
                                                            action="{{ route('job-type.update', $list->idjob_type) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class="modal-body pb-0">
                                            ...
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#delete_modal{{ $list->idjob_type }}"><i
                                                    class="ti ti-trash"></i></a>
                                            <div class="modal fade" id="delete_modal{{ $list->idjob_type }}">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <p class="mb-3">You want to delete all the marked items, this
                                                                ...
                                                                delete.</p>
                                                            <form
                                                                action="{{ route('job-type.destroy', $list->idjob_type) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
