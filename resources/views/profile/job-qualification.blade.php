    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Job Qualification</h2>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Job Qualification</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="modal fade" id="add_assets">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('job-qualification.store') }}" method="POST" role="form">
                                @csrf
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @foreach ($qualification as $list)
                                <tr>
                                    <td>
                                        <h6 class="fs-14 fw-medium">{{ $list->libelle_qualification }}</h6>
                                    </td>
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="#" class="me-2" data-bs-toggle="modal"
                                                data-bs-target="#edit_category{{ $list->idjob_qualification }}"><i
                                                    class="ti ti-edit"></i></a>
                                            <div class="modal fade" id="edit_category{{ $list->idjob_qualification }}">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <form
                                                            action="{{ route('job-qualification.update', $list->idjob_qualification) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class="modal-body pb-0">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input name="libelle" required type="text"
                                                                                class="form-control"
                                                                                value="{{ $list->libelle_qualification }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#delete_modal{{ $list->idjob_qualification }}"><i
                                                    class="ti ti-trash"></i></a>
                                            <div class="modal fade" id="delete_modal{{ $list->idjob_qualification }}">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <p class="mb-3">You want to delete all the marked items, this
                                                                ...
                                                                delete.</p>
                                                            <form
                                                                action="{{ route('job-qualification.destroy', $list->idjob_qualification) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
